...
type Repository interface {
	...
	ShopDailyPurchaseQuantities(accountID, characterID int64, shopID, businessDate string) (map[int]int64, error)
	...
	MysteryShopBoard(accountID, characterID int64, shopID string) (MysteryShopBoardState, error)
	MysteryShopPaidRefreshCount(accountID, characterID int64, shopID string, dayStart, dayEnd time.Time) (int, error)
	RefreshMysteryShop(req MysteryShopRefreshRequest) (MysteryShopBoardState, error)
